...
[X]Colourblind contrasting - sort colours???
[X]Add Keywords
[X]Add Term popup to spells (e.g. what is mass)
[X]Check site tablet
[X]Check works on mobile
[X]Resize art icons
[X]Get permission
[X]Buy domain
[X]Get published on domain
...
Journeyman Alchemist:
	Armour Salve (c): 1 Dung, 2 Leaf, 1 Ink
	Dazzling Liquid (c): 1 Bark, 1 Bone, 1 Glass, 1 Seed
...
Research (Requires a Scholar Feat or the Pointed Questions Feat)
Scout
Travel
