      ...
      },
      {
          ...
          "feats":[
              ...
              },
              {
                  ...
                  "call" : "N/A",
                  "art" : "person",
                  "description" : "<span>Various Effects and abilities specify “an unresisting target” such as searching, moving, diagnosing, etc. A target can normally choose to cooperate or resist these efforts. Some things that would remove the choice of resisting and make a target unresisting (unless they have a Feat or are using an item which specifies otherwise) would be: being unconscious, or being under the Sleep or Halt Effects.<p>A target that is being actively hostile towards should be considered obviously resisting.</p></span>",
                  "magicSchool" : ["Effect"]
              }
          ]
      },
...
if(isMobile){
  ...
  featCode = featCode.replace("<span><p>At no point should a player be out of character ", "<span style='font-size:11px;'><p>At no point should a player be out of character ");
  ...
  featCode = featCode.replace("<span>Various Effects and abilities specify ", "<span style='font-size:11px;'>Various Effects and abilities specify ");
