      ...
      },
      {
          ...
          "feats":[
              ...
              },
              {
                  ...
                  "description" : "Your character enters a crazed state which you should roleplay, shaking off their wounds for one last final fight. You must be unconscious to activate this Feat, and it costs 4 Vigour to activate. When activated the following happens to your character: <ul><li id='hrId'>Your torso immediately goes to -1 Body hits, if it wasn’t already</li><li id='hrId'>Your deathcount is reduced to 1 minute remaining (if it was greater than this)</li><li id='hrId'>For the next minute, you may use all your locations as if they were on 1 or more Body hits</li><li id='hrId'>You may not generate the Healing, Repair, or Stop Bleed Effects by any means (including by using potions or other items) or cast Spells</li><li id='hrId'>Leaving your death count will end this Effect immediately.</li></ul>",
                  "keywords" : ["Combat", "Martial Prowess"]
              },
              {
