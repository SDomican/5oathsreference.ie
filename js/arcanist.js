...
function manageKeywordsOnPopup(keyword){
  ...
  case "Consumable":
    ...
    return returnText; 
    case "Durable":
      returnText = "<span id='keyword' class='tooltip' data-tooltip='Durable items (d) have a duration of 3 events from the downtime they are made, but may be used multiple times.'data-tooltip-position='bottom' style='margin-top: 60px;'>Durable</span>";
      return returnText;
  default:
    return "N/A"
  }
